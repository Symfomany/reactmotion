...
import { MyGrid, MyGridTwo, MyGridThree } from "../styled/MyGrid";
          ...
          <Grid container spacing={24}>
            ...
            <MyGridThree xs={6} sm={6} visible={this.state.show}>
              <Paper className={classes.paper}>
                <img src="https://mcetv.fr/wp-content/uploads/2018/06/Selena-Gomez-Un-grand-couturier-l%E2%80%99insulte-de-moche-sur-un-photo-Instagram-big.png" />
              </Paper>
            </MyGridThree>
          </Grid>
        </div>
